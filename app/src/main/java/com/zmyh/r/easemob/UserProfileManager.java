...
import com.zmyh.r.easemob.applib.utils.HXPreferenceUtils;
import com.zmyh.r.easemob.domain.User;
import com.zmyh.r.easemob.parse.ParseManager;
...
//        });
        ...
        setCurrentUserNick("");
        setCurrentUserAvatar(UserObjHandle.getM_avatar(context));
