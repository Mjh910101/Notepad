 ...
 */
package com.zmyh.r.easemob.adapter;
...
import com.zmyh.r.easemob.activitys.AlertDialog;
import com.zmyh.r.easemob.activitys.ChatActivity;
import com.zmyh.r.easemob.activitys.ContextMenu;
import com.zmyh.r.easemob.activitys.ShowBigImage;
import com.zmyh.r.easemob.activitys.ShowNormalFileActivity;
import com.zmyh.r.easemob.activitys.ShowVideoActivity;
import com.zmyh.r.easemob.activitys.UserProfileActivity;
import com.zmyh.r.easemob.applib.controller.HXSDKHelper;
import com.zmyh.r.easemob.task.LoadImageTask;
import com.zmyh.r.easemob.task.LoadVideoImageTask;
import com.zmyh.r.easemob.utils.DateUtils;
import com.zmyh.r.easemob.utils.ImageCache;
import com.zmyh.r.easemob.utils.ImageUtils;
import com.zmyh.r.easemob.utils.SmileUtils;
...
public class MessageAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (message.direct == EMMessage.Direct.SEND) {
            UserUtils.setCurrentUserNick(context, holder.tv_usernick);
        }
...
//				});
        ...
        if (holder != null && holder.staus_iv != null) {
            holder.staus_iv.setClickable(false);
        }
