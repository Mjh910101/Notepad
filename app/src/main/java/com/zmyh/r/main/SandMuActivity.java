...
public class SandMuActivity extends Activity {
    ...
    private String area_id = "", type = "", mmChannel = "";
    ...
    @ViewInject(R.id.send_mu_picBox)
    private LinearLayout picBox;
    @ViewInject(R.id.send_mu_smphasisBox)
    private LinearLayout smphasisBox;
    @ViewInject(R.id.send_mu_progress)
    private ProgressBar progress;
    @ViewInject(R.id.send_mu_zsTypeText)
    private TextView zsTypeText;
    @ViewInject(R.id.send_mu_JText)
    private TextView jText;
    @ViewInject(R.id.send_mu_zgText)
    private TextView zgText;
    @ViewInject(R.id.send_mu_gfText)
    private TextView gfText;
    @ViewInject(R.id.send_mu_typeText)
    private TextView typeText;
    @ViewInject(R.id.send_mu_jzTimeText)
    private TextView jzTimeText;
    @ViewInject(R.id.send_mu_totalInput)
    private EditText totalInput;
    @ViewInject(R.id.send_mu_priceInput)
    private EditText priceInput;
    @ViewInject(R.id.send_mu_titleName)
    private EditText titleInput;
    @ViewInject(R.id.send_mu_remark)
    private EditText contentInput;
    @ViewInject(R.id.send_mu_people)
    private EditText nameInput;
    @ViewInject(R.id.send_mu_phone)
    private EditText phoneInput;
    @ViewInject(R.id.send_mu_addressInput)
    private EditText addressInput;
    @ViewInject(R.id.send_mu_cityText)
    private TextView cityText;
    @ViewInject(R.id.send_mu_mapText)
    private TextView mapText;
    @ViewInject(R.id.send_mu_indateText)
    private TextView indateText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_send_mu);
    ...
    @OnClick({R.id.title_back, R.id.send_mu_submitBtn, R.id.send_mu_zsType,
            R.id.send_mu_J, R.id.send_mu_zg, R.id.send_mu_gf,
            R.id.send_mu_type, R.id.send_mu_jzTime, R.id.send_mu_city,
            R.id.send_mu_map, R.id.send_mu_indate})
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.title_back:
                close();
                break;
            case R.id.send_mu_submitBtn:
                submit();
                break;
            case R.id.send_mu_zsType:
                setMuZsType();
                break;
            case R.id.send_mu_J:
                setMuJ();
                break;
            case R.id.send_mu_zg:
                setMuZg();
                break;
            case R.id.send_mu_gf:
                setMuGf();
                break;
            case R.id.send_mu_type:
                setMuType();
                break;
            case R.id.send_mu_jzTime:
                setMuJzTime();
                break;
            case R.id.send_mu_city:
                setCity();
                break;
            case R.id.send_mu_map:
//				setLocation();
                break;
            case R.id.send_mu_indate:
                showIndateList();
                break;
        }
    }
    ...
    private void setLocation(TroopObj obj) {
    ...
    private void initPicBox() {
        ...
        if (sendPicList.size() < 9) {
            picBox.addView(getPicView(R.drawable.add_pic_b_icon));
        }
    ...
    private boolean isFull() {
        ...
        if (mTroopObj.getMu_longitude() <= 0 || mTroopObj.getMu_latitude() <= 0) {
            return false;
        }
        return true;
    }
