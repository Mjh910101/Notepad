...
import com.zmyh.r.main.people.PeopleBaseAdapter;
 ...
 */
public class SeekForumActivity extends Activity {

    public final static String AREA = "mm_area";
    ...
    private ForumV2BaseAdapter pba = null;
    ...
    private void setDataList(List<DynamicObj> list) {
        if (pba == null) {
            pba = new ForumV2BaseAdapter(context, list);
    ...
    private void donwloadData() {
        ...
        String url = UrlHandle.getMmPost()
                + "?query="
                + JsonHandle.getHttpJsonToString(new String[]{"content.$like", "mmArea"}, new String[]{seekStr, mmArea}) + "&p="
